                ...
                <section className={styles.card}>
                    ...
                    <div className={styles.contactItem}>
                        ...
                        <div>
                            ...
                            <a href="mialto:gamX@gmail.com" 
                            className={styles.value}>gamX@gmail.com</a>
                        </div>
                    </div>
                    ...
                    <div className={styles.contactItem}>
                        ...
                        <div>
                            ...
                            className={styles.value}>+1 (234) 567-890</a>
                        </div>
                    </div>
                    ...
                    <div className={styles.contactItem}>
                        ...
                        <div>
                            ...
                            <p className={styles.value}>
                                ...
                                La Plata, Buneos Aires, Argentina
                            </p>
                        </div>
                    </div>
                </section>
